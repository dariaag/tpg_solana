...
export const initializeConfig = instruction(
  { d8: '0x69c9523ad8155ca3' },
  { config: 0, funder: 1, systemProgram: 2 },
  struct({
...
export const initializeTickArray = instruction(
  { d8: '0x0cffd4ca0ede0015' },
  { whirlpool: 0, funder: 1, tickArray: 2, systemProgram: 3 },
  struct({
    startTickIndex: i32,
  }),
);
export const initializeFeeTier = instruction(
  { d8: '0x7c353bd2d4068803' },
  { config: 0, feeTier: 1, funder: 2, feeAuthority: 3, systemProgram: 4 },
  struct({
    tickSpacing: u16,
    defaultFeeRate: u16,
  }),
...
export const setRewardEmissions = instruction(
  { d8: '0x1fdae27bb13d9fb0' },
  { whirlpool: 0, rewardAuthority: 1, rewardVault: 2 },
  struct({
    rewardIndex: u8,
...
export const updateFeesAndRewards = instruction(
  { d8: '0x6d78939d04b4a448' },
  { whirlpool: 0, position: 1, tickArrayLower: 2, tickArrayUpper: 3 },
  struct({}),
);
export const collectFees = instruction(
  { d8: '0x5593bd967c83fff3' },
  {
    whirlpool: 0,
    positionAuthority: 1,
    position: 2,
...
export const setDefaultFeeRate = instruction(
  { d8: '0xe27c374c56ca9dd3' },
  { whirlpoolsConfig: 0, feeTier: 1, feeAuthority: 2 },
  struct({
    defaultFeeRate: u16,
  }),
);
export const setDefaultProtocolFeeRate = instruction(
  { d8: '0x12ec959abce59a54' },
  { whirlpoolsConfig: 0, feeAuthority: 1 },
  struct({
    defaultProtocolFeeRate: u16,
  }),
);
export const setFeeRate = instruction(
  { d8: '0x1b9aa9ffca2733ef' },
  { whirlpoolsConfig: 0, whirlpool: 1, feeAuthority: 2 },
  struct({
    feeRate: u16,
  }),
);
export const setProtocolFeeRate = instruction(
  { d8: '0x9922766e37e15b98' },
  { whirlpoolsConfig: 0, whirlpool: 1, feeAuthority: 2 },
  struct({
    protocolFeeRate: u16,
  }),
...
export const setFeeAuthority = instruction(
  { d8: '0x161a3e1db843c9f0' },
  { whirlpoolsConfig: 0, feeAuthority: 1, newFeeAuthority: 2 },
  struct({}),
);
export const setCollectProtocolFeesAuthority = instruction(
  { d8: '0xbe1c0042f78d6c52' },
  {
    whirlpoolsConfig: 0,
...
export const setRewardAuthority = instruction(
  { d8: '0x686949090cbce5ce' },
  { whirlpool: 0, rewardAuthority: 1, newRewardAuthority: 2 },
  struct({
    rewardIndex: u8,
  }),
);
export const setRewardAuthorityBySuperAuthority = instruction(
  { d8: '0x094071adbcfe47f6' },
  {
    whirlpoolsConfig: 0,
    whirlpool: 1,
